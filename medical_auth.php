    ...
    <body>
        ...
        <?php require "navigation.php"?>
	  	...
	  	<div class="card-panel z-depth-3 center">
	  	    <h5>Your Medical Authority</h5>
	  	</div>
	  	
	  	<div class="card-panel z-depth-3">
	  	    <br>
	  	    <b>CMO Office</b>  :     Family and Health Welfare Department, Raipur<br>
            <b>Address</b>        :     Office of the Chief Medical and Health Officer, Old Nurses Hostel, Near DKS Building<br>
            <b>Contact Person</b> : Dr. K.S. Shandilya<br>
            <b>Email ID</b>       :      cmho_raipur@yahoo.co.in<br>
            <b>Contact No</b> :      2535304<br><br>
