<?php
    ...
    $sql = "SELECT id FROM attempt WHERE user_id = '".$_SESSION["user"]."' AND disability_id = '".$_SESSION["disability"]."';";
    ...
    if($count > 0) {
        session_start ();
        echo "<script type='text/javascript'> document.location = 'already.php'; </script>";
    }else {
        session_start ();
        $session_name = "user";
    ...
    <body>
        ...
        <?php require "navigation.php"?>
	  	...
	  	<div class="card-panel loginpanel center z-depth-3 <?php echo $_SESSION ["main_color"];?> ">
    	    <a class='dropdown-trigger btn white z-depth-3 black-text' href='#' data-target='dropdown1'>Language</a>
            <ul id='dropdown1' class='dropdown-content'>
                <?php
                    ...
                    while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                        echo "<li><a class='black-text' href='language.php?lang=".$row['id']."'>".$row['name']."</a></li>";
                    }
	  			?>
            </ul>
    	</div>
